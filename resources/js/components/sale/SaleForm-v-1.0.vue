                        ...
                        <div class="row">
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <legend
                                            class="text-white my-btn-primary p-1 reset"
                                        >
                                            বিক্রয় কপি:
                                        </legend>
                                    ...
                                    >
                                        <legend
                                            class="text-white my-btn-danger p-1 reset"
                                        >
                                            সৌজন্য কপি:
                                        </legend>
                                        <table class="table table-sm">
                                                ...
                                                >
                                                    ...
                                                    <td class="px-1">
                                                        ...
                                                        <input
                                                            type="number"
                                                            v-model="
                                                                citem.courtesy_quantity
                                                            "
                                                            @input="
                                                                updateCourtesyQuantity(
                                                                    index
                                                                )
                                                            "
                                                            style="width: 50px"
                                    ...
                                    <div class="input-group mb-2 row mx-0 px-0">
                                        <div
                                            class="input-group-prepend px-0 col-md-5 mx-0"
                                        >
                                            <label
                                                class="input-group-text col-md-12"
                                                for="inputGroupSelect01"
        ...
        if (!this.isNew) {
            ...
            if (response.data.payment_details.length > 0) {
                this.form.payment_method =
                    response.data.payment_details[0].payment_method;
